        ...
        <form className='w-full flex flex-col space-y-4 md:space-y-8 mt-4'>
          ...
          <div className='flex flex-col'>
            <div className='flex items-center space-x-4 md:space-x-8'>
                ...
                <div onClick={addCategory} className='bg-red-500 text-white px-4 py-2 font-semibold cursor-pointer'>Add</div>
            </div>
          ...
          <button onClick={handleCreate} className='bg-red-500 w-full md:w-[20%] mx-auto text-white font-semibold px-4 py-2 md:text-xl text-lg'>Create</button>
        </form>
